...
export class ExceljsService {
  ...
  generateExcelFix(pTit: string, pSubtit: any, objDato: any, pHeader:any, pCol:any, data:any[], pColtot:any, pHeader2:any, pCol2: any, data2:any[], pDicc: any) {
    ...
    //Footer Row
    let footerRow = worksheet.addRow(['ERRO - Laboratorio de semillas ']);
